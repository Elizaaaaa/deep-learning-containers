...
def test_tensorflow_train_mnist_gpu(tensorflow_training, gpu_only):
    if is_tf1(tensorflow_training):
        execute_ec2_training_test_indocker(tensorflow_training, TF1_KERAS_CMD)
    else:
...
def test_tensorflow_addons_gpu(tensorflow_training, gpu_only):
    if is_tf1(tensorflow_training):
        pytest.skip("This test is for TF2 only")
    execute_ec2_training_test_indocker(tensorflow_training, TF_ADDONS_CMD)


def test_tensorflow_addons_cpu(tensorflow_training, cpu_only):
    if is_tf1(tensorflow_training):
        pytest.skip("This test is for TF2 only")
    execute_ec2_training_test_indocker(tensorflow_training, TF_ADDONS_CMD)